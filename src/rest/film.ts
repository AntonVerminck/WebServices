...
export default (parent: KoaRouter) => {
  ...
  router.post('/',requireAdmin,validate(createFilms.validationScheme) ,createFilms);
  router.get('/:id',requireAuthentication,validate(getFilmsById.validationScheme) ,validate(getFilmsById.validationScheme), getFilmsById);
  router.put('/:id',requireAdmin,validate(updateFilms.validationScheme), updateFilms);
  router.delete('/:id',requireAdmin,validate(deleteFilms.validationScheme) ,deleteFilms);
